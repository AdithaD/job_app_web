/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 3df670525c8c0c2323c87cb556335313)
// Runtime types generated with workerd@1.20260120.0 2025-09-27 nodejs_als,nodejs_compat
declare namespace Cloudflare {
    interface GlobalProps {
        mainModule: typeof import("../.svelte-kit/cloudflare/_worker");
    }
    interface Env {
        job_app_storage: R2Bucket;
        job_app_db: D1Database;
        ASSETS: Fetcher;
...
declare namespace NodeJS {
    interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "R2_URL" | "R2_KEY_ID" | "R2_SECRET_ACCESS_KEY">> { }
}
